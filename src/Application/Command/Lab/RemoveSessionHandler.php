...
class RemoveSessionHandler
{
    ...
    /**
     * @param RemoveSession $command
     * @throws UnauthorizedActionException
     * @throws LabNotFoundException
     * @throws UserNotFoundException
     * @throws SessionNotFoundException
     */
    public function handle(RemoveSession $command): void
    {
        ...
        $lab->removeSession(new SessionId($command->sessionId()));
    }
}